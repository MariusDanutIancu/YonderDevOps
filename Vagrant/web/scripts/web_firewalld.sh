...
cp /home/vagrant/files/firewalld/go-interns.xml /etc/firewalld/services/postgre.xml 
cp /home/vagrant/files/firewalld/hugo.xml /etc/firewalld/services/postgre.xml 
